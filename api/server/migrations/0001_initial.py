        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pageview_count",
                    models.IntegerField(
                        default=0, help_text="Total page views in this hour"
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["site", "hour_bucket"],
                        name="server_hour_site_id_e2e8b2_idx",
                    ),
                    models.Index(
                        fields=["hour_bucket"], name="server_hour_hour_bu_78d792_idx"
                    ),
                ],
